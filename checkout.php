<?php include 'includes/html_top.php'; ?>
  ...
  <body>
    ...
    <?php include 'includes/mainmenu-area.php'; ?>
    ...
    <div class="single-product-area">
        ...
        <div class="container">
            <div class="row">
                ...
                <?php include 'includes/search-products-left.php'; ?>
                ...
                <div class="col-md-8">
                    <div class="product-content-right">
                        <div class="woocommerce">
                            ...
                            <div class="woocommerce-info">Tem um cupom? <a class="showcoupon" data-toggle="collapse" href="#coupon-collapse-wrap" aria-expanded="false" aria-controls="coupon-collapse-wrap"> Clique aqui para inserir seu código</a>
                            </div>
                                ...
                                <div id="order_review" style="position: relative;">
                                    <table class="shop_table">
                                        ...
                                        <tbody>
                                            <tr class="cart_item">
                                                <td class="product-name">
                                                    Água Deionizada <strong class="product-quantity">× 3</strong> </td>
                                        ...
                                        <tfoot>
                                            ...
                                            <tr class="shipping">
                                                <th>Frete</th>
                                                <td>Frete Grátis<input type="hidden" class="shipping_method" value="free_shipping" id="shipping_method_0" data-index="0" name="shipping_method[0]">
                                                </td>
                                            </tr>
                                    ...
                                    <div id="payment">
                                        <ul class="payment_methods methods">
                                            <li class="payment_method_bacs">
                                                ...
                                                <label for="payment_method_bacs">Transferência Bancária Direta </label>
                                                <div class="payment_box payment_method_bacs">
                                                    <p>Faça seu pagamento diretamente em nossa conta bancária. Use a ID do pedido como referência de pagamento. O seu pedido não será enviado até que os fundos tenham sido cancelados em nossa conta.</p>
                                                </div>
                                            </li>
                                            <li class="payment_method_cheque">
                                                <input type="radio" data-order_button_text="" value="cheque" name="payment_method" class="input-radio" id="payment_method_cheque">
                                                <label for="payment_method_cheque">pagamento por cheque </label>
                                                <div style="display:none;" class="payment_box payment_method_cheque">
                                                    <p>Por favor, envie seu cheque para o nome da loja.</p>
                                                </div>
                                            </li>
                                            <li class="payment_method_paypal">
                                                ...
                                                <div style="display:none;" class="payment_box payment_method_paypal">
                                                    <p>Pague via PayPal; Você pode pagar com seu cartão de crédito se você não tiver uma conta do PayPal.</p>
                                                </div>
                                            </li>
                                        </ul>
                                        ...
                                        <div class="form-row place-order">
                                            ...
                                            <input type="submit" data-value="Place order" value="COMPRAR" id="place_order" name="woocommerce_checkout_place_order" class="button alt btn-success-order">
...
<?php include 'includes/html_bottom.php'; ?>